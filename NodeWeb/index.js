...
http.createServer(function (req, res) {
  ...
  if (req.method == "POST") { // 接口 POST 形式
    ...
    if (pathName == "/getMessage") { // 获取留言信息
      ...
      res.write('<h1 style="text-align:center">jsliang 前端有限公司服务已开启！</h1><h2 style="text-align:center">详情可见：<a href="https://www.baidu.com//blob/master/other-library/Node/NodeBase.md" target="_blank">Node 基础</a></h2>');
